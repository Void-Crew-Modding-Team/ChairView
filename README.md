...
### 💡 Function - Pressing switch view (TAB) while in a chair shows the ship exterior view

### 🎮 Client Usage

- Install
- Sit in chair
- Press "Switch View" (TAB by default)
...
Drag and drop `ChairView.dll` into `Void Crew\BepInEx\plugins`
